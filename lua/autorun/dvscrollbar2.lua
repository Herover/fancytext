...
function PANEL:Init()
	...
	self.btnUp.Paint = function( panel, w, h ) return end
	...
	self.btnDown.Paint = function( panel, w, h ) return end
	
	self.btnGrip = vgui.Create( "DScrollBarGrip", self )
	self.btnGrip.Paint = function( panel, w, h ) return end
...
derma.DefineControl( "DVScrollBar2", "Another Scrollbar", PANEL, "Panel" )